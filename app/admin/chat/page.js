...
export default function AdminChat() {
  ...
  const [emojiPickerOpen, setEmojiPickerOpen] = useState(null); // id of message with emoji picker open
        ...
        {chats.map((msg) => (
          ...
          >
            ...
            {msg.image_url || imagePreviews[msg.id] ? (
              <img
                src={imagePreviews[msg.id] || msg.image_url} // Local preview or DB URL
                alt="Uploaded"
