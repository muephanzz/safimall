...
return (
    <div className="min-h-screen flex bg-gray-100">
      ...
      >
        ...
        <header className="fixed w-full top-0 left-0 right-0 p-2 bg-white shadow-md z-20 px-6 py-4 flex">
        ...
        <div className="max-w-7xl w-3/4 mx-auto bg-white rounded-3xl shadow-xl p-6 pt-20 min-h-[80vh]">
          {children}
        </div>
      </main>
    </div>
