...
export default function Checkout() {
  ...
  return (
    <div className="mt-28 items-center justify-center p-6 sm:p-0 lg:p-6 max-w-6xl mx-auto bg-gradient-to-br from-white to-slate-100 shadow-2xl rounded-3xl border border-gray-200">
